...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("tmajam/ipinfo")
    client.subscribe("tmajam/date")
    client.subscribe("tmajam/time")
    
    #Add the custom callbacks by indicating the topic and the name of the callback handle
    client.message_callback_add("tmajam/ipinfo", on_message_from_ipinfo)
    client.message_callback_add("tmajam/date", on_message_from_date)
